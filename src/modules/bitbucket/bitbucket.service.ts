...
export class BitbucketService {
    ...
    async updateRepo(repo: string, version: string): Promise<string> {
        ...
        await this.createCommit(newPackageJSON,workspace, repo, accessToken, newBranchName)
    ...
    private async createCommit(newPackageJSON: string, workspace, repo, accessToken, branch) {
